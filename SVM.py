...
data_set_name_list = ['IP', 'UP', 'SA', 'BOT','KSC']
...
if data_set_name == 'IP':
    ...
    ratio_list = [ratio_list_[dx], 0]
    ratio = ratio_list_[dx]
elif data_set_name == 'UP':
    ratio_list = [0.01, 0.005]
    ratio = 5
...
num_list = [45, 0]  # [train_num,val_num]

results_save_path = \
    os.path.join(os.path.join(os.getcwd(), 'output/results'), model_list[model_flag] + str("_") +
                 data_set_name + str("_") + str(time_current) + str("_seed_") + str(seed) + str("_ratio_") + str(10))
cls_map_save_path = \
...
if __name__ == '__main__':
    ...
    for curr_seed in seed_list:
        ...
        train_data_index, test_data_index, all_data_index = data_load_operate.sampling_SVM(ratio_list, num_list,
                                                                                              gt_reshape,
        ...
        print(f"train_time={training_time},test_time={testing_time}")
